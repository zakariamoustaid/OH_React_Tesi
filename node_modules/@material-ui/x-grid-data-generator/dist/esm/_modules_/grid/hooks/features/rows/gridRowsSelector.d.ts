...
export declare const gridRowsLookupSelector: import("reselect").OutputSelector<GridState, Record<GridRowId, import("../../../models/gridRows").GridRowData>, (res: InternalGridRowsState) => Record<GridRowId, import("../../../models/gridRows").GridRowData>>;
