...
export declare const sortedGridRowIdsSelector: import("reselect").OutputSelector<GridState, GridRowId[], (res1: GridSortingState, res2: GridRowId[]) => GridRowId[]>;
export declare const sortedGridRowsSelector: import("reselect").OutputSelector<GridState, Map<GridRowId, import("../../../models/gridRows").GridRowData>, (res1: GridRowId[], res2: Record<GridRowId, import("../../../models/gridRows").GridRowData>) => Map<GridRowId, import("../../../models/gridRows").GridRowData>>;
