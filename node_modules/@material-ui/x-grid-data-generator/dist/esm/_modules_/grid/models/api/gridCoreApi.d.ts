...
export interface GridCoreApi extends GridEventEmitter {
     ...
     */
    subscribeEvent: (event: string, handler: (params: any, event: MuiEvent<React.SyntheticEvent | DocumentEventMap[keyof DocumentEventMap] | {}>, details: any) => void, options?: GridSubscribeEventOptions) => () => void;
    /**
     * Emits an event.
