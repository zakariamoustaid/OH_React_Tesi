...
var bufferToArrayBuffer = _interopDefault(require('to-arraybuffer'));
...
var configureLogger_1 = configureLogger;
...
function ProgressEvent$1(type, progressEventRaw, target) {
...
ProgressEvent$1.prototype = new event();

ProgressEvent$1.prototype.constructor = ProgressEvent$1;

var progressEvent = ProgressEvent$1;

function CustomEvent$1(type, customData, target) {
    this.initEvent(type, false, false, target);
    this.detail = customData.detail || null;
}

CustomEvent$1.prototype = new event();

CustomEvent$1.prototype.constructor = CustomEvent$1;
...
var supportsBlob = blob.isSupported;
...
EventTargetHandler.prototype = event$1.EventTarget;
...
function fakeXMLHttpRequestFor(globalScope) {
    ...
    function FakeXMLHttpRequest(config) {
        ...
        this.responseType = "";
        this.response = "";
        this.logError = configureLogger_1(config);
    ...
    justExtend(FakeXMLHttpRequest.prototype, event$1.EventTarget, {
        async: true,
        ...
        readyStateChange: function readyStateChange(state) {
            ...
            var readyStateChangeEvent = new event$1.Event(
                "readystatechange",
                false,
                false,
                this
            ...
            if (this.readyState === FakeXMLHttpRequest.DONE) {
                ...
                if (supportsProgress) {
                    this.upload.dispatchEvent(
                        new event$1.ProgressEvent("progress", progress, this)
                    );
                    this.upload.dispatchEvent(
                        new event$1.ProgressEvent(event, progress, this)
                    );
                    this.upload.dispatchEvent(
                        new event$1.ProgressEvent("loadend", progress, this)
                    );
                }
        ...
        send: function send(data) {
            ...
            this.dispatchEvent(
                new event$1.Event("loadstart", false, false, this)
            );
        },
        ...
        uploadError: function uploadError(error) {
            if (supportsCustomEvent) {
                this.upload.dispatchEvent(
                    new event$1.CustomEvent("error", { detail: error })
                );
            }
        },
    ...
    justExtend(FakeXMLHttpRequest, states);
    justExtend(FakeXMLHttpRequest.prototype, states);
...
var fakeXhr = justExtend(fakeXMLHttpRequestFor(globalObject$1), {
...
const stubbedXhrs = new weakSet$1();
...
class XHRAdapter extends Adapter {
  ...
  onConnect() {
    ...
    this.assert('Running concurrent XHR adapters is unsupported, stop any running Polly instances.', !stubbedXhrs.has(context.XMLHttpRequest));
  ...
  async passthroughRequest(pollyRequest) {
    ...
    xhr.open(pollyRequest.method, pollyRequest.url, fakeXhr.async, fakeXhr.username, fakeXhr.password);
    ...
    let isBinary = false; // responseType will either be `arraybuffer` or `text`

    if (xhr.responseType === 'arraybuffer') {
      const buffer = buffer_1.from(xhr.response);
      isBinary = !utils.isBufferUtf8Representable(buffer);
  ...
  respondToRequest(pollyRequest, error) {
    ...
    if (pollyRequest.aborted) {
      ...
      const {
        ...
        body,
        isBinary
      } = pollyRequest.response;
      let responseBody = body;

      if (isBinary) {
        const buffer = buffer_1.from(body, 'hex');
...
//# sourceMappingURL=pollyjs-adapter-xhr.js.map
