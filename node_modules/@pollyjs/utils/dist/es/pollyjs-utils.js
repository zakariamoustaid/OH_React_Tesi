...
class PollyError extends Error {
  constructor(message, ...args) {
    super(`[Polly] ${message}`, ...args); // Maintains proper stack trace for where our error was thrown (only available on V8)
...
async function serialize$1(body) {
...
export { actions as ACTIONS, expiryStrategies as EXPIRY_STRATEGIES, httpMethods as HTTP_METHODS, httpStatusCodes as HTTP_STATUS_CODES, modes as MODES, PollyError, index as Serializers, URL, assert, buildUrl, isBufferUtf8Representable, timeout, timestamp };
