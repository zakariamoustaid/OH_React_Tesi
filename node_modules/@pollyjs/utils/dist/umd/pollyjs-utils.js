...
(function (global, factory) {
  ...
  (global = global || self, factory(global['@pollyjs/utils'] = {}));
  ...
  var httpMethods = ['GET', 'PUT', 'POST', 'DELETE', 'PATCH', 'MERGE', 'HEAD', 'OPTIONS'];
  ...
  function serialize$2(body) {
    if (supportsBuffer && body) {
      ...
      if (isBuffer$1(body)) {
        buffer = body;
      } else if (isArray$3(body) && body.some(function (c) {
        return isBuffer$1(c);
      })) {
